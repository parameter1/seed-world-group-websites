...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://p1-cms-assets.imgix.net/files/base/seedworldgroup/all/image/static/pro-logo.png?h=45&auto=format,compress',
      srcset: [
        'https://p1-cms-assets.imgix.net/files/base/seedworldgroup/all/image/static/pro-logo.png?h=45&auto=format,compress&dpr=2 2x',
      ],
    },
    footer: {
      src: 'https://p1-cms-assets.imgix.net/files/base/seedworldgroup/all/image/static/pro-logo.png?h=60&auto=format,compress',
      srcset: [
        'https://p1-cms-assets.imgix.net/files/base/seedworldgroup/all/image/static/pro-logo.png?h=60&auto=format,compress&dpr=2 2x',
      ],
    },
    corporate: {
  ...
  inquiry: {
    ...
    logo: 'https://p1-cms-assets.imgix.net/files/base/seedworldgroup/all/image/static/pro-logo.png?h=60&auto=format,compress&bg=FFFFFF&pad=5',
    bgColor: '#FFFFFF',
  },
};
